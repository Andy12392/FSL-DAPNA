...
parser.add_argument('--data', default='./places365_standard',
                    help='path to dataset')
parser.add_argument('--arch', '-a', metavar='ARCH', default='wideresnet28')
...
parser.add_argument('-e', '--evaluate', default=False, dest='evaluate',
                    help='evaluate model on validation set')
parser.add_argument('--pretrained', default=False, dest='pretrained',
...
def main():
    ...
    if args.arch.lower().startswith('wideresnet'):
        model  = wideresnet.WideResNet(num_classes=args.num_classes)
